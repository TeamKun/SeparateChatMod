...
public class GuiNewChatInner extends GuiNewChat
{
    ...
    public GuiNewChatInner(Minecraft mcIn)
    {
        super(mcIn);
        this.mc = mcIn;
    }

    public int drawChatCount(int updateCounter) {
        int count = 0;
        if (mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN && !drawnChatLines.isEmpty()) {
